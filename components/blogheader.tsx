	...
	return (
		<header className='border-4 shadow-2xl border-[#20102d] flex flex-row justify-between rounded-full my-9 mx-auto w-[70%] px-4 py-3 font-bold  bg-[#180c2a]'>
			...
			<div className='flex flex-row items-center justify-center space-x-3'>
				<div className='justify-center p-2 font-bold transition-all duration-300 ease-linear rounded-full hover:font-extrabold hover:scale-105  bg-[#4b05ad]/30'>
					Technology
				</div>
				<div className='justify-center p-2 font-bold transition-all duration-300 ease-linear rounded-full hover:font-extrabold hover:scale-105  bg-[#4b05ad]/30'>
					Philosophy
			...
			<div className='flex items-center'>
				<img
					...
					width={36}
					height={36}
					className='object-fill rounded-full hover:brightness-50 hover:scale-110'
				/>
			</div>
		</header>
	);
		...
		<header className='flex flex-col w-[90%] my-9 mx-auto p-4 font-bold  bg-[#180c2a] rounded-3xl'>
				...
				<div className='flex items-center space-x-1'>
					<div className='flex items-center'>
						<img
							...
							width={36}
							height={36}
							className='object-fill rounded-full hover:brightness-50 hover:box-shadow-lg hover:shadow-[#2c0076] hover:scale-110'
						/>
					</div>
					<button
			...
			>
				<ul className='flex flex-col mt-2 space-y-2 max-w-[90%] mx-auto'>
					<li>
						<div className=' p-2 rounded-full hover:bg-[#4b05ad]/30 hover:scale-105 transition-all ease-linear '>
							Nav Item 1
						</div>
					</li>
					<li>
					...
					<li>
						<div className='p-2 rounded-full hover:bg-[#4b05ad]/30 hover:scale-105 transition-all ease-# '>
							Nav Item 3
						</div>
					</li>
				</ul>
