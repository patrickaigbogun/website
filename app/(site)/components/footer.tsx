...
export default function Footer() {
	...
	return (
		...
		<footer className=" flex justify-center max-h-[18%] p-1 font-medium text-sm lg:text-base bg-gray-950 bg-opacity-15 backdrop-blur-lg text-white border-t-2 border-green-500 fixed inset-x-0 bottom-0 ">
